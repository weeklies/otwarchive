...
Feature: Edit Works Dates
  ...
  Scenario: Editing dates on a work
   ...
   When I select "1" from "work_chapter_attributes_posted_at_3i"
     And I select "January" from "work_chapter_attributes_posted_at_2i"
     And I select "1990" from "work_chapter_attributes_posted_at_1i"
     And I press "Preview"
     And I press "Update"
  ...
  # the work's updated date should change to match the most recent chapter pub date
   When I follow "Next Chapter"
     ...
     And I select "16" from "chapter_posted_at_3i"
     And I select "January" from "chapter_posted_at_2i"
     And I select "2013" from "chapter_posted_at_1i"
     And I press "Preview"
     And I press "Update"
